...
$Firstname = $lastname = $Phonecontact = $Emailaddress = $Homeaddress = $Gender = $Departmentname = null;
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO employee_details (First_Name, Last_Name, Phone_Contact, Email_Address, Home_Address, Gender, Department_Name)
    VALUES('$Firstname', '$lastname', '$Phonecontact', '$Emailaddress', '$Homeaddress', '$Gender', '$Departmentname')"; 
